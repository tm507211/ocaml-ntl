...
#define MPZ_val (*((mpz*)Data_custom_val(v)))
...
extern "C" {
	...
	CAMLlocal1(r);
	ZZ c = coeff(ZZX_val(polynomial), Int_val(position));
	_make_ZZ(&r, c);
	CAMLreturn(r);
    }
