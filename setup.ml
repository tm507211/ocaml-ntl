...
(* OASIS_START *)
(* DO NOT EDIT (digest: 28c23f4e4626fae523ef313a6919e427) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [OASISText.Para "Bindings to NTL: http://www.shoup.net/ntl/"];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_data_files = [];
                      bs_findlib_extra_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, ["-annot"])];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\185\006>Q\164\151oK)Z*\156\186,\tJ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
